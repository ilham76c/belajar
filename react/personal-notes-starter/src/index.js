      ...
      <div className="bg-gradient-to-r from-violet-900 to-fuchsia-700 min-h-screen w-screen">
        <div className="flex flex-row text-white">
          ...
          <div className="basis-full p-5">
            ...
            <div className="flex items-center gap-x-4 bg-blue-500 rounded-lg px-3 py-4 mt-4">
              {/* icon filter */}
              <svg
              ...
              <select className="bg-blue-500">
                <option id='1' value="no" disabled defaultValue>Filter</option>
                <option id='2' value="aktif">Aktif</option>
                <option id='3' value="nonaktif">Tidak Aktif</option>
              </select>
            ...
            <div className="flex gap-x-5 mt-3">
              <span>Catatan Aktif <span className='inline-block rounded-full py-1 px-2 bg-rose-500 text-sm text-center'>{this.state.notes.filter(obj => obj.arsip === false).length}</span></span>
              <span>Arsip <span className='inline-block rounded-full py-1 px-2 bg-rose-500 text-sm text-center'>{this.state.notes.filter(obj => obj.arsip === true).length}</span></span>
            </div>
