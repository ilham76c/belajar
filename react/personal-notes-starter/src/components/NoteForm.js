  ...
  render() {
    return (
      <div
        id='modal-form-note'
        tabIndex='-1'
        className={(this.props.showModal ? '' : 'hidden ') + 'overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full justify-center items-center flex'}
        aria-modal='true'
        role='dialog'
      >
